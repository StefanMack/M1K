...
#import platform
from smucAwgFunc import update_awg
from smucAwgFunc import update_awga
from smucAwgFunc import update_awgb
import config as cf
import logging
...
def MakeAWGMenu():
    ...
    amp1lab = ttk.Label(awg1ampl, text = "Min (V/mA)" ) 
    ...
    off1lab = ttk.Label(awg1off, text = "Max (V/mA)")
    ...
    amp2lab = ttk.Label(awg2ampl, text = "Min (V/mA)")
    ...
    off2lab = ttk.Label(awg2off, text = "Max (V/mA)")
