...
# -*- coding: utf-8 -*-
"""
Plot des Ladvorgangs unter messung des Batterieinnenwiderstands und der
Batteriespannung durch das Skript bat-charge-sine-cur.py
Besonderheit ist die doppelte X-Achse mit Zeit und Ladung.
